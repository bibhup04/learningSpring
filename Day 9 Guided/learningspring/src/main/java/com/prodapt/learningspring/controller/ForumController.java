...
@PostMapping("/post/{postId}/comment")
	    public String submitComment(@PathVariable int postId, String commenterName, @RequestParam String comment,@AuthenticationPrincipal UserDetails userDetails) throws ResourceNotFoundException  {
